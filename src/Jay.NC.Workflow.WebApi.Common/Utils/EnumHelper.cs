using Jay.NC.Workflow.WebApi.Common.Attributes;
using Jay.NC.Workflow.WebApi.Common.Extensions;
using Jay.NC.Workflow.WebApi.Common.Models.Business;
using System;
...
namespace Jay.NC.Workflow.WebApi.Common.Utils
{
    /// <summary>
    /// 枚举帮助类
    /// </summary>
